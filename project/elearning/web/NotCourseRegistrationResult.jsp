...
<table width=100% background='images/AdministratorBackground.jpg' height=73%>	
	<td width=10%></td><td>	
		<table width=100% bgcolor=#C1C1DD border=1 align=center><td align=center><tr>		<td valign=middle width=100% align=center height=50><font color=#333399><h2>You have <font color=#FF0000>not Registered </font>For Course !</td>
</table></td><td width=10%></td><tr><td></td><td align=right><font color=#FFFFFF><b>Click here For <a href='CourseRegistration.jsp'><font color=#FF3333>Course Regisration</font></a>  ! </font><td><tr></tr><td><td align=center valign=top>
