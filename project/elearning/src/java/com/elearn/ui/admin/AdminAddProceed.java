...
public class AdminAddProceed extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            if (i == 1) {
                ...
                pw.println("<body bgcolor=#E6DBFB><link rel='stylesheet' href='css/css_input.css'>");
                pw.println("<strong><h1><center><font color=blue>E-LEARNING</font></center></h1></strong>");
                pw.println("<br><h2>Admin Registration Successful </h2>");
                pw.println("<font color=blue><h2> Welcome to the New Experience of E-learning");
                pw.println("</h2><h3>New Admin id For Further Correspondense is <font color=red><b>" + userid + "</b><br>");
                pw.println("<br><center><input class='but' type=button onClick=window.location.href='"+req.getContextPath()+"/Home.jsp' value='Home'>");
            ...
            pw.print("<center><table border=10 width=90%><tr><td  height=40% bgcolor=#9185C9 width=90%>");
            pw.print("<h1><font color=#CCFFFF><center><br>");
            pw.print("Admin already exist<br></font> <font color=#FF9933>or</font>");
