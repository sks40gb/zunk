        ...
        subStream = new InputStream() {
                    ...
                    // just keep trying.  this is to allow detection of lost connection
                        ...
                        for (;;) {
                            try {
                                ...
                                logger.error("Exception while reading an input stream for a byte." + e);
                    ...
                    // just keep trying.  this is to allow detection of lost connection
                        ...
                        for (;;) {
                            try {
                                ...
                                logger.error("Exception while reading an input stream for multiple bytes." + e);
                                StringWriter sw = new StringWriter();
                                e.printStackTrace(new PrintWriter(sw));
                                logger.error(sw.toString());
                                throw e;
                ...
                // return data length between 1 and Integer.MAX_VALUE.
                    ...
                    private int getCount() throws IOException {
                        ...
                        if (magic != MOS_MAGIC) {
                            Log.quit("Invalid magic reading MultiInputStream: 0x" + Integer.toHexString(magic));
                        }
                    ...
                    // just keep trying.  this is to allow detection of lost connection
                        ...
                        for (;;) {
                            try {
                                ...
                                logger.error("Exception due to connection timeout." + e);
                                StringWriter sw = new StringWriter();
                                e.printStackTrace(new PrintWriter(sw));
                                logger.error(sw.toString());
                                throw e;
