...
public class Log {
    ...
    private static SimpleDateFormat stampFormatter = new SimpleDateFormat("MMdd.HH:mm:ss");
    private static PrintWriter writer = null;
    private static Date now = null;
    private static StringBuffer buffer = new StringBuffer();
    private static String logFileName = "run";
    ...
    private static void openWriter() {
        ...
        String logDateTime = nameFormatter.format(now, new StringBuffer(19), new FieldPosition(0)).toString();
        ...
        if (binResource != null) {
            ...
            try {
                ...
                logger.error("Error in path (" + logFileName + ".log): " + uee);
        ...
        try {
            ...
            logger.error("Error opening log file (" + logFileName + ".log): " + e);
            StringWriter sw = new StringWriter();
    ...
    public synchronized static void quit(String msg, Throwable e) {
        ...
        if (quitExceptionClass != null) {
            ...
            try {
                quitClassConstructor = quitExceptionClass.getConstructor(new Class[]{String.class});
            ...
            try {
                quitException = (RuntimeException) quitClassConstructor.newInstance(new Object[]{msg});
            } catch (InstantiationException e1) {
                logger.error("Runtime Exception during quit."+e1);
                StringWriter swt = new StringWriter();
                e1.printStackTrace(new PrintWriter(swt));
            ...
            if (SwingUtilities.isEventDispatchThread()) {
                ...
                try {
                    ...
                    logger.error("Exception during fatal error processing ."+t);
                    StringWriter sw = new StringWriter();
                    t.printStackTrace(new PrintWriter(sw));
                    logger.error(sw.toString());
                    if (writer != null) {
                        writer.println("Exception during fatal error processing");
                        logger.error("Exception during fatal error processing"+writer);
                        StringWriter swt = new StringWriter();
