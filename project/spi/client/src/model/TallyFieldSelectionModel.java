 ...
 * @author sunil
 */
public class TallyFieldSelectionModel extends AbstractTableModel {
    
    private Object[][] data;
    private boolean DEBUG = false;
    private String[] columnNames = {"Column1", "Column2"};

    public TallyFieldSelectionModel(Object[][] data) {
        this.data = data;
    }
    
    public TallyFieldSelectionModel(Object[][] data ,String headings[]) {
        this.data = data;
