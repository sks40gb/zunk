 ...
 * @author balab
 */
public class ListingMarkingTableModel extends AbstractTableModel {
    ...
    public ListingMarkingTableModel(Object[][] data) {
        this.data = data;
    }
    
    public ListingMarkingTableModel(Object[][] data ,String headings[]) {
        this.data = data;
