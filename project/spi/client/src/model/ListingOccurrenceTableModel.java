 ...
 * @author balab
 */
public class ListingOccurrenceTableModel extends AbstractTableModel{

   private Object[][] data;
    private boolean DEBUG = false;
    private String[] columnNames = {"Column1", "Column2"};
    
    public ListingOccurrenceTableModel(Object[][] data) {
        this.data = data;
    }
    
    public ListingOccurrenceTableModel(Object[][] data ,String headings[]) {
        this.data = data;
