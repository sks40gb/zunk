/* $Header: /home/common/cvsarea/ibase/dia/src/dbload/Attic/XrefReaderBRS.java,v 1.1.2.1 2007/03/21 10:45:10 nancy Exp $ */
package dbload;

/**
 * Implementation of cross-reference reader for BRS files.
 */
public class XrefReaderBRS extends XrefReader {
    private static String GROUP_ONE_BATES = "00000000";
    private static String GROUP_ONE_PATH  = "source_folder";
    private static String PATH  = "data";

    private static String DBID   = "DBID";
    //private static String VOLUME = "CDVO";
    //private static String BOX    = "CBOX";
