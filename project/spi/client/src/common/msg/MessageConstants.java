...
public interface MessageConstants {
    ...
    //final public static String T_REQUEST_CODING_BY_BATES = "request_coding_by_bates";
    ...
    //final public static String T_NO_BATCHES_AVAILABLE = "no_batches_available";
    // final public static String T_PROJECT_NAME = "project_name";
    //attributes added ends
    ...
    final public static String A_LEVEL = "level";    //sunil
    final public static String A_STD_FIELD_ID = "standard_field_id";    //end
    ...
    final public static String qairReportPath = "http://winserver/Spireports/ReportViewerQAIR.aspx?reportPath=/Spireports/rptQAIR&qair_number="; 
    //------------------------end ------------------------------------------
   // final public static String A_CODING_MANULE_DATA = "coding_anule_data";
    ...
    public static final String A_FUNCTION_SCOPE = "function_scope";
    //PVR implemetion end
    ...
    //Message Constants for Tally Process
