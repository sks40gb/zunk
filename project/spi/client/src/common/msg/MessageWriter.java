...
public class MessageWriter implements MessageConstants {
    ...
    public MessageWriter (final OutputStream out, String dtd) throws IOException {
        ...
        writer = new BufferedWriter(
                     new OutputStreamWriter(this.out, MessageConstants.UTF_8));
        //debug only
    ...
    public void close () throws IOException {
        ...
        if (writer != null) {
            ...
            //For debug purpose : prints the Client-side XML
            //System.out.println("XmlOutput.........." + cache.toString());
            writer.close();
            //debug only
            cache = null;
            //debug only
    ...
    public void startElement (String element) throws IOException {
        ...
        if (DEBUG) {
            System.out.println("MessageWriter.startElement "+   element);
        }
        if (isElementOpen) {
            //debug only
            cache.append(">\n");
