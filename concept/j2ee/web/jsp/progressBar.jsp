...
<head>
	...
	<script type="text/javascript" src="${path}js/bramus/jsProgressBarHandler.js"></script>
				...
				document.observe('dom:loaded', function() {
					...
					manualPB = new JS_BRAMUS.jsProgressBar(
								...
								75,
								{
									...
									width		: 154,
									height		: 11,
									boxImage	: '${path}images/bramus/custom1_box.gif',
									barImage	: '${path}images/bramus/custom1_bar.gif'
								}
							);
