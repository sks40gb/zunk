 ...
 *
 *
 * 2. Defining the Generic Type - It is restricted that it should have same Type (class)
 * Ex :
 ...
 * List<Object> list = new ArrayList<String>(); - incorrect, even String is subclass of Object, it won't compile. Generic
 * Type should be the same.
 *
 * 3. Uses of Generic Type - It follows the Inheritance concept
 * ex:
...
public class AllPossibleCases<A,B extends Subject> {
    ...
    public static void main(String[] args) {
        AllPossibleCases<String, Subject> s = new AllPossibleCases<String, Subject>();
       
        
        String str = s.getInstance();
